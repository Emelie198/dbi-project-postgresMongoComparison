...
public class RuntimeComparisonTest {
     ...
     private @Autowired at.pmrc.mongoembedded.persistence.Seeder mongoEmbeddedSeeder;
     private @Autowired EmbeddedReviewRepository mongoEmbeddedReviewRepository;

     private @Autowired at.pmrc.postgres.persistence.UserRepository postgresUserRepository;
